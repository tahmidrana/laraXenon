        ...
        <div class="panel-body">
            <table id="role_datatable" class="display compact hover row-border responsive no-wrap" style="width:100%">
                ...
                <tr>
                    ...
                    <td>{{ $role->name }}</td>
                    <td><a href="{{ url('role/update_role/'.$role->id) }}" class="btn btn-blue btn-sm btn-icon">Edit</a> <a href="{{ url('role/delete_role/'.$role->id) }}" onclick="return confirm_role_delete()" class="btn btn-red btn-sm btn-icon">Delete</a> </td>
                </tr>
                @endforeach
                </tbody>
            </table>
